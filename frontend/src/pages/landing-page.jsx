...
function LandingPage() {
    ...
    return (
        <>
            ...
            <div className="px-20 grid items-center justify-center grid-cols-2 gap-5">
                ...
                <div>
                    <img className="w-96" src='../../public/header-pic.jpg' alt="" />
                </div>
            </div>

            <div className="my-20">
                <Carousel
                    className="mx-auto px-20 py-5 w-[70%] bg-bbackground rounded-lg"
                >
                    ...
                    <p className="mx-auto mt-2 mb-10 w-96 text-center text-gray-500">
                    ...
                    <CarouselContent className="-ml-2 cursor-grab active:cursor-grabbing">
                        <CarouselItem className="basis-1/2 pl-2 pr-2">
