...
function TopNav() {
    ...
    return (
        <nav className="w-full px-6 py-3 md:py-0 flex items-center  bg-background">
            ...
            <DropdownMenu>
                <DropdownMenuTrigger className={"ml-auto" + (userContext.user.type === 'company' ? ' block' : userContext.user.type === 'user' ? ' hidden md:block' : '')}>
                    <div className="py-4 flex gap-3">
                        <Avatar>
                            <AvatarImage src="https://github.com/shadcn.png" />
                            <AvatarFallback>CN</AvatarFallback>
                ...
                <DropdownMenuContent className={(userContext.user.type === 'company' ? ' block' : userContext.user.type === 'user' ? ' hidden md:block' : '')}>
                    <DropdownMenuLabel>My Account</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem>
                        <Button className="flex gap-1" onClick={() => { userContext.logout() }}>
