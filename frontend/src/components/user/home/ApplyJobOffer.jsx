...
function ApplyJobOffer() {
    ...
    return (
        <div className="flex flex-col bg-white rounded-lg w-[900px]">
            <div className="top-info flex bg-white rounded-lg py-4 px-[50px] mb-4 justify-center justify-between">
                <div className=" flex flex-col mt-4">
                    <p className="text-gray-600 ">Posted {formatDistanceToNow(jobOffer.created_at)}</p>
                    <p className="text-gray-800 font-bold text-3xl mt-2"> {jobOffer.job_title}</p>
                    ...
                    <p className="text-gray-600"> Required Experience : {jobOffer.exp_years} years</p>
                </div>
